...
const newApi = new (0, _gallery.NewApi)();
...
function search(e) {
    ...
    try {
        ...
        console.log(error);
        (0, _notiflixDefault.default).Notify.failure("Oops, sorry, something went wrong...");
    }
}
...
function queryGet() {
    ...
    newApi.resetPage();
    clearGalleryMarkup();
    if (newApi.query === "") return (0, _notiflixDefault.default).Notify.failure("There is no query");
}
...
async function loadMoreBtn() {
    try {
        ...
        if (response.data.total === response.data.totalHits) collectionEmpty();
    } catch (error) {
        console.log(error);
        (0, _notiflixDefault.default).Notify.failure("Oops, sorry, something went wrong...");
    }
...
},{"notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","./gallery":"cPBte","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"cPBte":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NewApi", ()=>NewApi);
...
class NewApi {
    ...
    query = "";
    fetchPhotos() {
        const response = (0, _axiosDefault.default).get(`${this.#BASE_URL}?key=${this.#API_KEY}&q=${this.query}&image_type=photo&orientation=horizontal&safesearch=true&page=${this.page}&per_page=40`);
        this.pageIncrement();
        return response;
    }
    pageIncrement() {
